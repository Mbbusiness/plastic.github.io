jQuery(document).ajaxComplete(function () {
    ...
    if ($("#calendar2").length > 0) {
        ...
        document.querySelector('#calendar2 thead tr:nth-child(1) td:nth-child(2)').onclick = function () {
            Calendar2("calendar2", document.querySelector('#calendar2 thead .month-name-wrapper').dataset.year, parseFloat(document.querySelector('#calendar2 thead .month-name-wrapper').dataset.month) - 1);
        };
